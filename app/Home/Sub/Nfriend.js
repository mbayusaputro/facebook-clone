...
import Rq from './Subs/Add';

export default class Nfriend extends Component {
    ...
    return(
      <Card>
        <List style={{height:30}}>
          <Text style={{marginLeft:15, marginTop:4, fontWeight:'bold'}}>Orang yang Mungkin Anda Kenal</Text>
        </List>
        <List>
          {this.anime.map((anime,key)=> <Add key={key} anime={anime}/>)}
        </List>
      </Card>
    )
  }
